  ...
  return (
    <form className="flex-column form">
      ...
      <div className="form-control flex-column">
        <label htmlFor="amount" className="mb">Mortgage Amount</label>
      ...
      <div className="form-control flex-column">
        <label htmlFor="term" className="mb">Mortgage Term</label>
        <div className="flex frame">
      ...
      <div className="form-control flex-column">
        <label htmlFor="rate" className="mb">Interest Rate</label>
        <div className="flex frame">
      ...
      <button><img src="/images/icon-calculator.svg" alt="calculator"></img>Calculate Repayments</button>
    </form>
  )
}
